-- =====================================================================
-- YIYO GYM — Correcciones de la auditoría
-- Para una base que ya tiene 0001 a 0016 ejecutados.
-- Cierra los huecos de aislamiento entre entrenadoras y desbloquea la
-- edición del catálogo sembrado de ejercicios y alimentos.
-- =====================================================================
